...
export default {
  ...
  methods: {
    ...
    handleMenuTheme (theme) {
      this.$store.dispatch('admin/ToggleTheme', theme)
    },
    doCopy () {
  ...
  storageOptions: {
    ...
    handleLayout (mode) {
      this.$store.dispatch('admin/ToggleLayoutMode', mode)
    ...
    changeColor (color) {
      if (this.primaryColor !== color) {
        this.$store.dispatch('admin/ToggleColor', color)
        updateTheme(color)
      }
    },
    ...
    handleFixSiderbar (fixed) {
      if (this.layoutMode === 'topmenu') {
        this.$store.dispatch('admin/ToggleFixSiderbar', false)
        return
      }
