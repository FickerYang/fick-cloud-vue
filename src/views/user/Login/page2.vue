    ...
    handleSubmit(e){
      ...
      validateFields(validateFieldsKey, { force: true }, (err, values) => {
        if (!err) {
          ...
          loginParams.password = "admin";
          loginParams.grant_type = "password";
          loginParams.scope = "all";

          // loginParams.clientId = "597494481295-dd79sund7ef8kr338t87eqajl27spg7a.apps.permission.com";
          // loginParams.clientSecret = "daf2333dd314xfd";
          // loginParams.loginName = loginParams.username;
